    ...
    <div className="flex items-center justify-center p-6 overflow-hidden font-arial">
      ...
      >
        ...
        <motion.svg
          ...
          style={{
            scale: useTransform(scrollProgress, [0, 1], [1, 1.02]),
            willChange: isCardHovered ? "transform" : "auto",
          }}
        >
          <g clipPath="url(#clip0_1_494)">
            ...
            <motion.rect
              ...
              style={{
                fillOpacity: useTransform(scrollProgress, [0, 1], [0.15, 0.25]),
                rotate: useTransform(
                  scrollProgress,
                  [0, 1],
                  [-144.536, -139.536]
            ...
            <motion.rect
              ...
              style={{
                fillOpacity: useTransform(scrollProgress, [0, 1], [0.15, 0.23]),
                rotate: useTransform(scrollProgress, [0, 1], [0, -3]),
                transform:
